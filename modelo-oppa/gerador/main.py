...
import sys, openpyxl
from common import *
import premissas, bases, pessoas, investimentos, engine, detalhe, resumo, socios, comousar
...
_, SO  = socios.build(wb, P, A, FL, D, PE, BLOCOS)
_, R   = resumo.build(wb, P, A, I, BLOCOS, FL, U)
comousar.build(wb, P, PE)

ordem = ["Como usar", "Resumo", "Premissas", "Pessoas", "Sócios", "DRE Projetada",
         "Análise Fluxo", "Faturamento", "Usuários", "Cenários", "Investimentos",
         "Aportes", "Tributos"]
...
cores = {"Como usar": "C00000", "Resumo": "1F3864", "Premissas": "FFC000", "Pessoas": "FFC000",
         ...
         "Usuários": "2E5C8A", "Sócios": "1F3864", "Cenários": "7030A0", "Investimentos": "808080",
