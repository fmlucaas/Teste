...
CATS = ["Equipamentos", "Marca e jurídico", "Certificações"]
I = {}
...
def build(wb, P, PE):
    ...
    for cat in CATS:
        ...
        I[cat] = r
        r += 1
    rotulo(ws, r, "Desenvolvimento do app (pessoal capitalizado)", 1)
    preencher_linha(ws, r, lambda i, L: f'=Pessoas!{L}{PE["invest"]}', BRL, color=VERDE_LINK)
    I["Desenvolvimento"] = r
    nota(ws, f"{L_PCT}{r}", "Vem da aba Pessoas: linhas classificadas como Investimento.")
    r += 1
    ...
    I["total"] = r
    for cat in CATS + ["Desenvolvimento"]:
